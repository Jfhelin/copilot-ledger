...
2. **[Fixed Floor 2/3] Tool & Skill Overhead** — Tool count is nearly free; most
...
#07 (Tool & Skill Overhead), which already has the capture curve, a pinned
